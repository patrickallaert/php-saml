...
[![Build Status](https://api.travis-ci.com/patrickallaert/php-saml.png?branch=1.0)](http://travis-ci.com/patrickallaert/php-saml) [![License](https://poser.pugx.org/patrickallaert/php-saml/license.png)](https://packagist.org/packages/patrickallaert/php-saml)
...
Otherwise, use a *PSR-4* capable loader mechanism, knowing that namespace `Saml2\` should
be matched against the `src/Saml2` folder.
